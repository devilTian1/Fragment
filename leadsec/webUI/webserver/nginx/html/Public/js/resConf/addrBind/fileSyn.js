function openFSFilenameDialog() {
    var url   = 'Function/layout/showDialog.php';
    var data  = {
        tpl : 'resConf/addrBind/fileSyn_filename_editDialog.tpl'
    };
    var title   = '添加文件名控制';
    var buttons = {};
...
/***********************************************************************************************************/
function openFSBlacklistDialog() {
    var url   = 'Function/layout/showDialog.php';
    var data  = {
        tpl : 'resConf/addrBind/fileSyn_blacklist_editDialog.tpl'
    };
    var title   = '添加内容黑名单';
    var buttons = {};
    buttons['添加下一条'] = function() {
