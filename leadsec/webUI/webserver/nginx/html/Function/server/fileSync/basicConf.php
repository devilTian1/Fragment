<?php
	...
	define('CACERTNAME_PATH', '/usr/local/cert/fscert/lenovo_ng_fs_ca.crt');
    define('SISCERTNAME_PATH', '/usr/local/cert/fscert/lenovo_ng_fs_user.crt');
    define('SISKEYNAME_PATH', '/usr/local/cert/fscert/lenovo_ng_fs_user.key');
    define('USERKEYWORDNAME_PATH', '/usr/local/cert/fscert/lenovo_ng_fs_user.key.pwd');
	define('COMMON_NAME_PATH','/usr/local/cert/fscert/lenovo_ng_fs_common_name');
