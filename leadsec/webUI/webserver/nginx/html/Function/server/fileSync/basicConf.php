<?php
    require_once($_SERVER['DOCUMENT_ROOT'] . '/Function/common.php');
     ...
     //定义四个文件存放路径
    define('CACERTNAME_PATH', '/usr/local/cert/msgcert/lenovo_ng_msg_ca.crt');
    define('SISCERTNAME_PATH', '/usr/local/cert/msgcert/lenovo_ng_msg_user.crt');
    define('SISKEYNAME_PATH', '/usr/local/cert/msgcert/lenovo_ng_msg_user.key');
    define('USERKEYWORDNAME_PATH', '/usr/local/cert/msgcert/lenovo_ng_msg_user.key.pwd');
	define('COMMON_NAME_PATH','/usr/local/cert/msgcert/lenovo_ng_msg_common_name');
    ...
    if ($_FILES['CAcert']['name'] || $_FILES['SIScert']['name'] ||  
        ...
        // 刷新页面
        $tpl =  'client/msgTrans/basicConfTable.tpl';
     	$status = certStatus();
