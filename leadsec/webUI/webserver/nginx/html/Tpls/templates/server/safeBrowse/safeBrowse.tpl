...
<button class="floatLeft button" type="submit" onClick="openSafeBrowseDialog()" id="add">添加</button>
<script type="text/javascript" src="Public/js/server/safeBrowse/safeBrowse.js"></script>
