...
<button class="floatLeft button" type="submit" onClick="openSmtpMailDialog()" id="add">添加</button>
<script type="text/javascript" src="Public/js/server/mail/smtpMail.js"></script>
