...
<button class="floatLeft button" type="submit" onClick="openTcpCustomizedDialog()" id="add">添加</button>
<script type="text/javascript" src="Public/js/server/customized/tcpCustomized.js"></script>
