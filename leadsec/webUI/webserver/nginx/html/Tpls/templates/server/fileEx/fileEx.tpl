...
<button class="floatLeft button" type="submit" onClick="openFileExDialog()" id="add">添加</button>
<script type="text/javascript" src="Public/js/server/fileEx/fileEx.js"></script>
