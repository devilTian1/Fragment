    <form action="Function/server/fileSync/basicConf.php" method="POST" id="fileCertConfForm"
...
<script type="text/javascript" src="Public/js/server/fileSync/basicConf.js"></script>
...
$(document).ready(function(){
	...
	freshTable('Function/server/fileSync/basicConf.php', $('#certListTable'));
});
</script>
