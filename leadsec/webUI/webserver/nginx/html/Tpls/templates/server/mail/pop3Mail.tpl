...
<button class="floatLeft button" type="submit" onClick="openPop3MailDialog()" id="add">添加</button>
<script type="text/javascript" src="Public/js/server/mail/pop3Mail.js"></script>
