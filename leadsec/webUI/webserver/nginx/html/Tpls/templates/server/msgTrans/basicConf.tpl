    <form action="Function/server/msgTrans/basicConf.php" method="POST" id="fileCertConfForm"
...
<script type="text/javascript" src="Public/js/server/msgTrans/basicConf.js"></script>
...
$(document).ready(function(){
	...
	freshTable('Function/server/msgTrans/basicConf.php', $('#certListTable'));
});
</script>
