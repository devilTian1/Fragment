...
<button class="floatLeft button" type="submit" onClick="openUdpCustomizedDialog()" id="add">添加</button>
<script type="text/javascript" src="Public/js/server/customized/udpCustomized.js"></script>
