<{include file='layout/search.tpl' colNames='time_grp.name,time_grp.subname'}>
<table class="column_95 textMid tablesorter" id="timeGroupTable">
    <caption>时间组</caption>
    <thead>
        <tr>
            <th class="column_10">序号</th>
            <th class="column_20" name="time_grp.name">名称</th>
...
<script type="text/javascript"> 
    $(document).ready(function() {
        renderStandardUi();
        freshTable('Function/resConf/time/timeGroup.php', $('#timeGroupTable'), 'ORDER BY time_grp.name ASC LIMIT 10 OFFSET 0');
        sortTableInit($('#timeGroupTable'), {0: {sorter: false}, 2: {sorter: false}, 3: {sorter: false}, 
            4: {sorter: false}}, [[0,0], [1,0]]);
    });
</script>
