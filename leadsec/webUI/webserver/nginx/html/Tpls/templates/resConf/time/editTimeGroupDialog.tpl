<form action="Function/resConf/time/timeGroup.php" method="POST" id="editTimeGroupForm" onSubmit="return false;">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <input class="w150" type="text" name="resTimeName" size="15" maxlength="15" value="<{$timeGroup.name}>"
        ...
        <div class="row">
            ...
            <input class="comment" name="comment" id="comment" value="<{$timeGroup.comment}>"/>
        </div>
        <br class="clearFloat"/>
    </fieldset>
