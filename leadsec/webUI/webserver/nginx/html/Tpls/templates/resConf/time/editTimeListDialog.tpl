<form action="Function/resConf/time/timeList.php" method="POST" id="editTimeListForm" onSubmit="return false;">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <input class="w150" type="text" name="resTimeName" size="15" maxlength="15" value="<{$timeList.name}>"
        ...
        <div class="row">
            ...
            <input class="comment" name="comment" id="comment" value="<{$timeList.comment}>"/>
        </div>
        <br class="clearFloat"/>
    </fieldset>
</form>
