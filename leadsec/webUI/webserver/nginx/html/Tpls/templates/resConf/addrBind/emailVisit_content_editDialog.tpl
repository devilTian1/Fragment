...
<form action="Function/resConf/addrBind/emailVisit_content.php" method="POST" id="editForm" onSubmit="return false;">
    ...
    <input type="hidden" name="id" value="<{$res.id}>"/>
     <fieldset>
        ...
        <div class="row">
         ...
         <div class="row">
          <label for="destip">关键字:<em class="required">*</em></label>
          <input type="text" name="destip" value="<{$res.destip}>" />( 如法轮功，关键字最大长度为30)
        </div>
        ...
        <div class="row">
            <label>类别:</label>
            <div class="floatLeft">
               <input name="http" type="radio" value="all" checked="checked"/>主题
            </div>
            <div class="floatLeft">
               <input type="radio" name="http" value="part"/>正文
            </div>
        </div>
