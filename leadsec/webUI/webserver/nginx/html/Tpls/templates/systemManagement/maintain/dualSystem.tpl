...
<form action="Function/systemManagement/maintain/dualSystem.php" method="POST" id="dualSystemForm" 
    ...
    <table class="column_95 textMid">
        ...
        <tbody>
            <tr>
                <td><input type="radio" name="defaultStart" value="systemA"
                        <{if ''===$versionA}>disabled="disabled"<{/if}>/>systemA</td>
                <td><input type="radio" name="defaultStart" value="systemB" 
                        <{if ''===$versionB}>disabled="disabled"<{/if}>/>systemB</td>
            </tr>
            <tr>
                <td colspan="2">
