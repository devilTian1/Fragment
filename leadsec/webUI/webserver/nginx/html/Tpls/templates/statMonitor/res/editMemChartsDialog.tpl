<form action="Function/statMonitor/res/res.php?mem=1" method="POST" id="MemChartForm" onSubmit="return false;">
...
$(document).ready(function (){
    ...
    $("#freshButton").bind("click",function() {
        ...
        ajaxSubmitForm($('#MemChartForm'), '结果',undefined,undefined,
                successCallback);
    });   
});   
</script>
