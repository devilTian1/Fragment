    ...
    <ol class="pagination floatLeft">
        ...
        <{for $pageNo=1 to $pageCount }>
            <{assign var='a' value="`$clickedPageNo-$pageNo`"}>
            <{assign var='b' value="`$pageNo-$clickedPageNo`"}>
            <{if ($pageNo != 1 && $pageNo != $pageCount) && ($a > 3 || $b > 2)}>
                <{continue}>
            <{/if}>
            <{if $clickedPageNo == $pageNo or $clickedPageNo > $pageCount}>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        li.click(function() {
            ...
            freshLogTable('<{$func}>', <{$tableDom|default: "$('.tablesorter')"}>,
