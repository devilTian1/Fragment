<form action="Function/log/view/bizLog.php?search=1" method="POST" id="logSearchParamsForm" 
...
<div class="pager floatRight">
    <{include file='layout/pagination.tpl' func='Function/log/view/bizLog.php'}>
</div>
<script type="text/javascript" src="Public/js/log/view/bizLog.js"></script>
<script type="text/javascript">
    $(document).ready(function() {
        renderStandardUi();
        freshTable('Function/log/view/bizLog.php', $('#logTable'), true);
