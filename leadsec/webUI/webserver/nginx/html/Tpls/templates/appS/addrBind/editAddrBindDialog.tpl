<form action="Function/appS/addrBind/addrBind.php" method="POST" id="editIpAddrForm"
    ...
    <legend>地址列表维护</legend>
			...
			<div class="row">
				...
				<input type="text" class="width132" id="ipaddress" name='ipaddress' value="<{$edit_result.ip}>">
			</div>

            <div class="row">
				<label for="dport"><em class="required">*</em>MAC地址:</label>
				<input type="text" class="width132" id="macaddress" name='macaddress' value="<{$edit_result.mac}>">
            </div>
