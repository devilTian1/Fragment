<form action="Function/client/safeBrowse/keywordFilter.php" method="POST"  id="editKeywordFilterForm" onSubmit="return false;">
	...
	<fieldset>
    	...
    	<div class="row">
    		<label>禁止的内容:</label>
    		<input type="text" name="context_txt" id="context_txt" value="" size="30" maxlength="30"/>    		
    	</div>
        ...
        <div class="row">
        	<label>备注:</label>        	
        	<input class="comment" name="comment" id="comment" value="<{$editKey.comment}>"/>
        </div>
	</fieldset>
</form>
...
$(document).ready(function() {
	...
	$("#addContext").click(function(){
		...
		if(flag==0&&context!=''){
			var option = "<option value='"+context+"'>"+context+"</option>";                   
