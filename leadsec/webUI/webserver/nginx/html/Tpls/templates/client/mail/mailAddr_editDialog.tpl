<form action="Function/client/mail/mailAddr.php" method="POST"  id="editMailAddrForm" onSubmit="return false;">
	...
	<fieldset>
    	...
    	<div class="row">
    		...
    		<input class="width10em" type="text" name="mailName" value="<{$editMail.name}>" size="15" maxlength="15"
    	...
    	<div class="row">
    		<label>邮件地址:</label>
    		<input class="width10em" type="text" name="mailAddr_txt" id="mailAddr_txt" value="" size="30" maxlength="30"/>    		
    	</div>
    	...
    	<div class="row">
    		...
    		<{html_radios class="radio" name=mailType label_ids=true values=array('recv', 'sender')
        ...
        <div class="row">
        	<label>备注:</label>        	
        	<input class="width10em comment" name="comment" id="comment" value="<{$editMail.comment|escape}>"/>
        </div>
	</fieldset>
</form>
