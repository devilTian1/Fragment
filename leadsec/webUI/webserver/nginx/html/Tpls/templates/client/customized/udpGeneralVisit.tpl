<{include file='layout/search.tpl' colNames='id,sa,lip,lport,time,comment'}>
...
<button class="standard floatLeft" style="position: static"
    onclick="openNewUdpCommClientAclDialog()">添加
</button>
...
<script type="text/javascript"> 
    $(document).ready(function() {
        renderStandardUi();
        freshTable('Function/client/customized/udpGeneralVisit.php',
            $('#udpGeneralVisitTable'), 'ORDER BY id ASC LIMIT 10');
