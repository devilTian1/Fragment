    <form action="Function/client/msgTrans/basicConf.php" method="POST" id="fileCertConfForm"
...
<script type="text/javascript" src="Public/js/client/msgTrans/basicConf.js"></script>
...
$(document).ready(function(){
	...
	freshTable('Function/client/msgTrans/basicConf.php', $('#certListTable'));
});
</script>
