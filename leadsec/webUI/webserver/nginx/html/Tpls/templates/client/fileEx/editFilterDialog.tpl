<form action="Function/client/fileEx/filter.php" method="POST"
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <input class="filesize" type="text" name="sizemin" size="6"
                maxlength="6" value="<{$data.sizemin}>"/>
            <label class="simpleLabel">K</label>
        </div>
        <div class="row">
            <label for="sizemax">&nbsp;</label>
            <label class="simpleLabel" for="sizemax">上限:</label>
            <input class="filesize" type="text" name="sizemax" size="6" 
                maxlength="6" value="<{$data.sizemax}>"/>
            <label class="simpleLabel">K</label>
        </div>
