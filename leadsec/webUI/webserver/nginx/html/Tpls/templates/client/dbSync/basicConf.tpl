    <form action="Function/client/dbSync/basicConf.php" method="POST" id="fileCertConfForm"
...
<script type="text/javascript" src="Public/js/client/dbSync/basicConf.js"></script>
