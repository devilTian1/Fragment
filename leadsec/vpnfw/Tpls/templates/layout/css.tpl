...
<link rel="stylesheet" href="<{$smarty.const.THEME_PATH}>/css/upload.css" type="text/css" />
<link rel="stylesheet" href="<{$smarty.const.THEME_PATH}>/css/tablesorter/style.css" type="text/css" />
<link rel="stylesheet" href="<{$smarty.const.THEME_PATH}>/css/jquery.tooltip.css" type="text/css" />
