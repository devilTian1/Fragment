...
//echo $type;
//echo $subtype;
$tabmenu=returnSubmenu($menuArr,'server',$type,$subtype);
$picmenu=returnPicmenu($menuArr,'server',$type,$subtype);

if($subtype==""){
	$tplurl="server/".$type.".tpl";
}else{
	$tplurl="server/".$type."/".$subtype.".tpl";
}
if($type=="overview"){
...
//echo $picmenu;
$tpl->assign('mainmenu',"server");//主menu
