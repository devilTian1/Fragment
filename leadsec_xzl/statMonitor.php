...
//echo $type;
//echo $subtype;
$tabmenu=returnSubmenu($menuArr,'statMonitor',$type,$subtype);
$picmenu=returnPicmenu($menuArr,'statMonitor',$type,$subtype);

if($subtype==""){
	$tplurl="statMonitor/".$type.".tpl";
}else{
	$tplurl="statMonitor/".$type."/".$subtype.".tpl";
}
if($type=="overview"){
...
//echo $picmenu;
$tpl->assign('mainmenu',"statMonitor");//主menu
