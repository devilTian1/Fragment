<?php /* Smarty version Smarty-3.1.12, created on 2012-10-07 18:11:02
         compiled from "/usr/local/webserver/nginx/html/Fragment/leadsec_xzl/tpls/templates/systemManagement/quick.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53134306850722826a92b67-65481709%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '74feba91aee6fc108b56836123b6b60984899712' => 
    array (
      0 => '/usr/local/webserver/nginx/html/Fragment/leadsec_xzl/tpls/templates/systemManagement/quick.tpl',
      1 => 1349658477,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53134306850722826a92b67-65481709',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50722826b2aee5_01519925',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50722826b2aee5_01519925')) {function content_50722826b2aee5_01519925($_smarty_tpl) {?><!-- tabs -->
<div class="tabs">
    <ul>
 ...
 $_smarty_tpl->tpl_vars['limenu']->index=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['limenu']->key => $_smarty_tpl->tpl_vars['limenu']->value){
$_smarty_tpl->tpl_vars['limenu']->_loop = true;
 $_smarty_tpl->tpl_vars['limenu']->index++;
 $_smarty_tpl->tpl_vars['limenu']->first = $_smarty_tpl->tpl_vars['limenu']->index === 0;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['tabmenu']['first'] = $_smarty_tpl->tpl_vars['limenu']->first;
?>	
          <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['tabmenu']['first']){?>
          	 <li class='visitedTab'><?php echo $_smarty_tpl->tpl_vars['tabmenu']->value['name'];?>
</li>
          <?php }?>   
      <?php } ?>
    </ul>
