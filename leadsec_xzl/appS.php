...
//echo $type;
//echo $subtype;
$tabmenu=returnSubmenu($menuArr,'appS',$type,$subtype);
$picmenu=returnPicmenu($menuArr,'appS',$type,$subtype);

if($subtype==""){
	$tplurl="appS/".$type.".tpl";
}else{
	$tplurl="appS/".$type."/".$subtype.".tpl";
}
if($type=="overview"){
...
//echo $picmenu;
$tpl->assign('mainmenu',"appS");//主menu
